namespace GTDoro.Migrations
{
    ...
    internal sealed class GTDoroConfiguration : DbMigrationsConfiguration<GTDoro.Core.DAL.GTDoroContext>
    {
        ...
        protected override void Seed(GTDoro.Core.DAL.GTDoroContext context)
        {
